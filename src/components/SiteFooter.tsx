      ...
      <div className="container-page py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/75">
            ...
            <li className="flex items-start gap-2"><Mail className="h-4 w-4 mt-0.5 shrink-0" /> <a href="mailto:support@adeprom.co.uk" className="hover:text-white">support@adeprom.co.uk</a></li>
          </ul>
        </div>
      </div>
