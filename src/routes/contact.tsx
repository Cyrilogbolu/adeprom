...
function Contact() {
  ...
  function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    window.location.href = `mailto:Leyedayo@gmail.com?subject=Website%20Enquiry&body=${body}`;
    setSent(true);
  }
  return (
    <>
      ...
      <section className="section-pad">
        <div className="container-page grid lg:grid-cols-2 gap-10">
          <div className="space-y-5">
            ...
            <InfoCard icon={Mail} title="Email" value="Leyedayo@gmail.com" href="mailto:Leyedayo@gmail.com" />
